...
ALLOWED_ORIGINS=https://chattify.site,https://www.chattify.site,https://api.chattify.site,https://www.api.chattify.site,http://localhost:3000,http://localhost:3001

# Laravel Backend URL
LARAVEL_API_URL=https://api.chattify.site
